...
if err != nil {
logger.Warn("model-gateway-agent: could not load tool policy, falling back to deny-all",
...
// verifyHMAC verifies the HMAC-SHA256 signature of a raw message payload.
...
// Compute HMAC over the raw payload with signature field removed for verification.
